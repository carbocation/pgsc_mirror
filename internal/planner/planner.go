...
func Plan(previous, desired []model.Entry) []Change {
	...
	for id := range ids {
		...
		case o.Status != n.Status:
			c.Kind = Withdraw
		case o.PGSName != n.PGSName || o.TraitReported != n.TraitReported || o.TraitMapped != n.TraitMapped || o.TraitEFO != n.TraitEFO || o.ReleaseDate != n.ReleaseDate || o.License != n.License || o.SourceURL != n.SourceURL:
			c.Kind = Metadata
		default:
			c.Kind = Unchanged
		}
